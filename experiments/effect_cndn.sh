...
do
time $python play.py with verbose=False seed='41' noise_rel=$noise model=$model rels='33 35 37 97 99 101 161 163 165' n_node=1024 data='single_fam_tree'
time $python play.py with verbose=True seed='41' noise_rel=$noise model=$model rels='33 35 37 97 99 101 161 163 165' n_node=32 data='cycprod'

time $python play.py with verbose=False seed='41' noise_rel=$noise model=$model rels='66 68 70 130 132 134 194 196 198' n_node=1024 data='single_fam_tree'
time $python play.py with verbose=True seed='41' noise_rel=$noise model=$model rels='66 68 70 130 132 134 194 196 198' n_node=32 data='cycprod'
