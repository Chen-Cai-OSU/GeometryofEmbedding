...
class EmbeddingModel(abc.ABC):
    ...
    def fit(self, X, early_stopping=False, early_stopping_params={}, model_name = None):
        ...
        for epoch in epoch_iterator_with_progress:
            ...
            import os
            from ..common.aux import make_dir
            import sys
            ...
            save_name = '' + model_name if model_name is not None else 'my-model'
            saver.save(self.sess_train, os.path.join(dir, save_name), global_step=epoch)
...
class ComplEx(EmbeddingModel):
    ...
    def     __init__(self,
        ...
        super().__init__(k=k, eta=eta, epochs=epochs, batches_count=batches_count, seed=seed,
                         ...
                         loss=loss, loss_params=loss_params,
                         regularizer=regularizer, regularizer_params=regularizer_params,
                         verbose=verbose, modify_flag=modify_flag)
    ...
    def fit(self, X, early_stopping=False, early_stopping_params={}, model_name = 'ComplEx'):
        ...
        """
        super().fit(X, early_stopping, early_stopping_params, model_name=model_name)
